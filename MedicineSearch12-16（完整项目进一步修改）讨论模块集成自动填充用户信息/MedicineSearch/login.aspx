<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="MedicineSearch.login" %>
    ...
    <div id="container" class="container" style="background:url(../images/head.jpg); padding-left:20px;">
            <div class="col-md-6" ">
                ...
                <form id="Form1" role="form" runat="server">
                  ...
                  <asp:Button ID="Button2" runat="server"  class="btn btn-default" Text="注册" OnClick="Button2_Click" />
                    </form>
